    ...
    <Box m={2}>
      ...
      >
        <Box>
          ...
          >
            What are all the Functional skills did you master in
          </Typography>
          <Box display="flex" flexWrap="wrap" pb={4} gap={2}>
            {targetIndustry.map((item) => (
              <Chip
                ...
                key={item}
                label={item}
                deleteIcon={<CloseIcon fontSize="medium" />}
        ...
        <Typography lineHeight={4} fontWeight={600} fontSize={"16px"}>
          ...
          <span style={{ color: "#0071D4", fontWeight: "600" }}>
            impressive
          </span>
          )
        </Typography>
        <Card variant="outlined">
          <CardContent>
            <Grid container spacing={2} justifyContent='start' p={3}>
        ...
        <Dialog open={openDialog} onClose={handleCloseDialog}>
          <DialogTitle>Rate yourself (0-5) in {selectedChip}</DialogTitle>
          <DialogContent>
            <Rating
